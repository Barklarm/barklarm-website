...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        Barklarm lets you focus on your work, and we will let you know if anything important happens.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Barklarm is multiplatform and can be used in any operating system.
      </>
    ),
  },
];
